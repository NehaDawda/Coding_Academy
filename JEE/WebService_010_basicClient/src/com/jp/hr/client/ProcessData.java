...
public class ProcessData {
	...
	public static void main(String[] args) {
		try {
			...
			ArrayList<Employee> list = soapServices.getEmpList();
			...
			Employee employee = new Employee(4, "Neha", "Dawda");
			System.out.println(soapServices.joinNewEmployee(employee));
